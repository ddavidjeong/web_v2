  ...
  return (
    <div className="bg-s-p-1 p-4 md:p-8 md:grid md:grid-cols-4">
      ...
      <div className="text-white col-span-1 md:col-span-2">
        <span className="bg-clip-text text-white text-4xl font-bold hover:text-transparent duration-300">
          project archive
        </span>
        ...
        <div className="text-left text-[18px] font-bold pt-6 pb-1">
          full stack/swe{" "}
        </div>

        <ProjectInputs />
        <div className="text-left text-[18px] font-bold pt-12 pb-1">
          data analysis/ml{" "}
        </div>
        <DataProjectInputs />
      </div>
