    ...
    <div className="bg-s-p-2">
      <div className="p-8 grid grid-cols-4">
        ...
        <div className="col-span-2 ">
          ...
          <a
            className="block hover:text-slate-200 duration-200"
          ...
          <div className="text-white text-[14px] font-light opacity-70">
            © 2025 | David Jeong
            <div>
              Built with Typescript, designed with Tailwind
              and CSS, coded in Visual Studio Code.{" "}
            </div>
          </div>
        </div>
